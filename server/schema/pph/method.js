...
const genPDF = async (p) => {
  try {
    ...
    const col2 = [
      ...
      [{ text: '7', border: [true, false, false, false], alignment: 'center' }, { text: 'Bonus', border: [false, false, false, false] }, { text: intpre0(p.dr0b).format(), border: [false, false, true, false], alignment: 'right' }],
