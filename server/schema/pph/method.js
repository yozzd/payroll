...
const genPDF = async (p) => {
  try {
    ...
    const col1 = [
      ...
      [{ text: '7', border: [true, false, false, false], alignment: 'center' }, { text: 'Other Income', border: [false, false, false, false] }, { text: '0', border: [false, false, true, false], alignment: 'right' }],
    ...
    const col2 = [
      ...
      [{ text: '7', border: [true, false, false, false], alignment: 'center' }, { text: 'Other Income', border: [false, false, false, false] }, { text: intpre0(p.dr0).format(), border: [false, false, true, false], alignment: 'right' }],
