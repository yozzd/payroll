  ...
  const p = await Payroll.aggregate([
    ...
    { $unwind: '$employee' },
    {
      $group: {
        ...
        sum8: { $sum: '$employee.dr0' },
        sum9: { $sum: '$employee.df0' },
        sum10: { $sum: '$employee.cy0' },
        sum12: { $sum: '$employee.er0' },
        sum13: { $sum: '$employee.cz0' },
        sum14: { $sum: '$employee.da0' },
        sum15: { $sum: '$employee.db0' },
        sum16: { $sum: '$employee.es0' },
      },
    },
    {
      $addFields: {
        sum11: { $sum: '$employee.gross' },
        sum17: { $sum: '$employee.ttax' },
      },
    },
  ]);
