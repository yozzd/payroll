  ...
  <div>
    ...
    >
      ...
      <el-table-column prop="aw0" width="100" align="right">
        ...
        <template slot="header" slot-scope="scope">
          <client-only>
            <p v-snip="1" title="Total Tunjangan Tetap">
              Total Tunjangan Tetap
            </p>
          </client-only>
        </template>
      </el-table-column>
      <el-table-column prop="ax0" min-width="100" align="right">
        <!--eslint-disable-next-line vue/no-unused-vars-->
        <template slot="header" slot-scope="scope">
          <client-only>
            <p v-snip="1" title="Upah (Gaji Pokok + Tunjangan Tetap)">
