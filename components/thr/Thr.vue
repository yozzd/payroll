...
import { Thrs } from '../../apollo/query/thr';
import { ImportThr } from '../../apollo/mutation/import';
import { ThrDelete } from '../../apollo/mutation/thr';
      ...
      this.$confirm('This will permanently delete the file. Continue?', 'Warning', {
        ...
        await this.$apollo.mutate({
          ...
          update: (store, { data: { thrDelete } }) => {
            ...
            const index = cdata.thrs.findIndex((v) => v._id === thrDelete._id);
            if (index > -1) {
              cdata.thrs.splice(index, 1);
            }
            store.writeQuery({
              query: Thrs,
              variables: {
