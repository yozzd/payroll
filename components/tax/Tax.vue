...
import { Tax } from '../../apollo/query/tax';
import { ImportTax } from '../../apollo/mutation/import';
import { TaxDelete } from '../../apollo/mutation/tax';
      ...
      this.$confirm('This will permanently delete the file. Continue?', 'Warning', {
        ...
        await this.$apollo.mutate({
          ...
          update: (store, { data: { taxDelete } }) => {
            ...
            const index = cdata.tax.findIndex((v) => v._id === taxDelete._id);
            if (index > -1) {
              cdata.tax.splice(index, 1);
            }
            store.writeQuery({
              query: Tax,
              variables: {
